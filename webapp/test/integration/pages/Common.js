sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zwf/app", ".html");
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#zworkflow_128-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#zworkflow_128-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("zwf.test.integration.pages.Common", {
