sap.ui.define([
	...
	"zwf/test/integration/pages/Common",
	"zwf/test/integration/pages/shareOptions"
				...
				theShareTileButtonShouldContainTheRememberedObjectName: function() {
					return this.waitFor({
						...
						matchers: function(oButton) {
							var sObjectName = this.getContext().currentItem.getBindingContext().getProperty("ZWfDocument");
